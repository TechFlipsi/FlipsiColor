...
namespace flipsicolor
{
    ...
    bool InferenceEngine::modellLaden(const QString& modellId, const QString& dateiPfad)
    {
        ...
        {
            fcWarn("Inferenz") << "Modell-Datei nicht gefunden:" << dateiPfad;
            return false;
        }
        ...
        try
        {
            ...
            fcInfo("Inferenz") << "Modell geladen:" << modellId;
            return true;
        }
        catch ( const Ort::Exception& e )
        {
            fcWarn("Inferenz") << "ONNX Modell-Fehler:" << e.what();
            return false;
        }
    }
    ...
    InferenceEngine::inferenz(const QString& modellId, const QVector<float>& eingabe, const QVector<int64_t>& form)
    {
        ...
        {
            fcWarn("Inferenz") << "Modell nicht geladen:" << modellId;
            return {};
        }
        ...
        {
            fcWarn("Inferenz") << "Inferenz-Fehler:" << e.what();
            return {};
        }
    }
