...
{
    if (stufe < m_stufe) return;

    QString stufenName;
    switch (stufe) {
    case Stufe::Debug:    stufenName = "DEBUG"; break;
    case Stufe::Info:     stufenName = "INFO";  break;
    case Stufe::Warnung:  stufenName = "WARN";  break;
    case Stufe::Fehler:   stufenName = "ERROR"; break;
    }
